...
app/
  ...
  models/
    WeatherData.js      Mongoose schema for geospatial weather data
  routes/
    index.js            Root router mounted at /api/geo-data
    weatherRoutes.js    Route definitions for all geo-data endpoints
  controllers/
    weatherController.js  Controller functions (fetch, save, retrieve)
